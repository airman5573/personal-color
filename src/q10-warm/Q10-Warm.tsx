import Step10Img from './warm-step10.png';
import Choice1Img from './q10-warm-choice-1.png';
import Choice2Img from './q10-warm-choice-2.png';
...
function Q10Warm() {
  ...
  const handleClick = (choice: number) => {
    ...
    navigation(Path.q11warm);
  };

  return (
    <Container isAllImageLoaded={allImageCount === loadedImageCount}>
      <div className="q10 q10-warm v-center">
        <img
          src={Step10Img}
          alt=""
